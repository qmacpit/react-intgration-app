...
/***/ function(module, exports, __webpack_require__) {
	...
	var _a = __webpack_require__(157);

	var _a2 = _interopRequireDefault(_a);

	var _b = __webpack_require__(158);
	...
	var componentMap = {
	  A: function A(data) {
	    ...
	    return _react2['default'].createElement(_a2['default'], { data: props });
	  },
	  B: function B(data) {
	    var props = _extends({}, data);
	    return _react2['default'].createElement(_b2['default'], props);
	  }
	};
	window.init = function (element, componentName, data) {
	  console.log(("5fa3b9"));
	  _react2['default'].render(componentMap[componentName](data), element);
	};

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/qmacpit/code/priv/react-router-app/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
